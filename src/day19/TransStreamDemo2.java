 ...
 *    而该转换流对象要接收一个字节流输出流，而且还可以操作文件的字符输出流。
 *
...
//        BufferedWriter bufw = new BufferedWriter(new OutputStreamWriter(new FileOutputStream("out.txt")));
        ...
        BufferedReader bufr = new BufferedReader(new InputStreamReader(new FileInputStream("javaTest.iml")));
